...
const Navbar = () => {
    ...
    // Array of Objects that we use it later.
    const navItems = [
                            ...
                            {navItems.map((item) => {
                                ...
                                */
                                ...
                                >
                                    ...
                                    <span
                                        className={`absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-[#6366f1] to-[#a855f7] trasform origin-left transition-transform duration-300 ${activeSection === item.href.substring(1)
                                                ? "scale-x-100"
